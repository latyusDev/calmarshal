'use client'
import { createEventType } from '@/app/actions/action'
...
const NewEventRoute = () => {
    ...
    <div className='flex flex-1 items-center justify-center w-full h-full'>
            ...
            <CardHeader className='w-full'>
                ...
                <CardDescription> 
                    Create new appointment that allows people to book you
                </CardDescription>
            </CardHeader>
            ...
            <form id={form.id} onSubmit={form.onSubmit} action={action} noValidate>
                <CardContent className='grid gap-y-5'>
                    ...
                    <div className='flex flex-col gap-y-2'>
                        ...
                        <div className='flex rounded-md'>
                            ...
                            placeholder='Example-url-1' className='rounded-l-none'/>
                ...
                <div className='grid gap-y-2 '>
                    ...
                    <input type="hidden"
                        name={fields.videoCallSoftware.name} key={fields.videoCallSoftware.key} value={activePlatform}
                    
                    />
                    <ButtonGroup >
                        <Button type='button'  variant={activePlatform === 'Zoom Meeting'?'secondary':'outline'}  
                        onClick={()=>setActivePlatform('Zoom Meeting')} className='w-fullf'>Zoom</Button>
                        <Button type='button' variant={activePlatform === 'Google Meet'?'secondary':'outline'} 
                        onClick={()=>setActivePlatform('Google Meet')} className='w-fullf'>Google Meet</Button>
                        <Button type='button' variant={activePlatform === 'Microsoft Teams'?'secondary':'outline'} 
                        onClick={()=>setActivePlatform('Microsoft Teams')} className='w-fullf'>Microsoft Teams</Button>
                    </ButtonGroup>
                ...
                <CardFooter className='flex justify-between mt-7'>
                    ...
                    <SubmitButton text='Create Event Type' className='w-auto' />
                </CardFooter>
            </form>
            </Card>
